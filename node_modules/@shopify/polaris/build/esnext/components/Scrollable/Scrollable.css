.Polaris-Scrollable_1ed9o { --pc-scrollable-shadow-size: var(--p-space-500); --pc-scrollable-shadow-color: rgba(0, 0, 0, 0.15); --pc-scrollable-shadow-bottom: 0 var(--pc-scrollable-shadow-size)
...
.Polaris-Scrollable_1ed9o:focus { outline: var(--p-border-width-2) solid var(--p-color-border-interactive-focus); outline-offset: var(--p-space-050); }
