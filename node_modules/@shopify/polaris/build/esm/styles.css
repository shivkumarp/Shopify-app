@charset "UTF-8";
:root { --polaris-version-number: '11.21.0'; }
...
.Polaris-Scrollable:focus { outline: var(--p-border-width-2) solid var(--p-color-border-interactive-focus); outline-offset: var(--p-space-050); }
...
.Polaris-Popover { max-width: calc(100vw - var(--p-space-800)); margin: 0.3125rem var(--p-space-200) var(--p-space-400); box-shadow: var(--p-shadow-xl); border-radius: var(--p-border-radius-2); -webkit-backface-visibility: hidden; backface-visibility: hidden; will-change: left, top; }
...
.Polaris-Popover__ContentContainer { position: relative; overflow: hidden; background: var(--p-color-bg); border-radius: var(--p-space-200); /* Prevent Scrollable's box shadows overflowing the rounded corners of this element on Safari prior to tech preview version 156. See: https://bugs.webkit.org/show_bug.cgi?id=68196 */ isolation: isolate; }
...
.Polaris-Badge-Pip { --pc-pip-size: var(--p-space-200); --pc-pip-color: var(--p-color-icon); --pc-border-width: 0.07813rem; display: inline-block; color: var(--pc-pip-color); height: var(--pc-pip-size); width: var(--pc-pip-size); border: var(--p-border-width-2) solid var(--pc-pip-color); border-radius: var(--p-border-radius-full); flex-shrink: 0; }
...
.Polaris-ActionList__Item { --pc-action-list-item-min-height: var(--p-space-1000); --pc-action-list-item-vertical-padding: calc((var(--pc-action-list-item-min-height) - var(--p-font-line-height-2))/2); -webkit-appearance: none; appearance: none; margin: 0; padding: 0; background: none; border: none; font-size: inherit; line-height: inherit; color: inherit; cursor: pointer; position: relative; display: block; width: 100%; min-height: var(--pc-action-list-item-min-height); text-align: left; text-decoration: none; cursor: pointer; padding: var(--pc-action-list-item-vertical-padding) var(--p-space-200); border-radius: var(--p-border-radius-1); border-top: var(--p-border-width-1) solid transparent; color: inherit; }
...
html[class~="Polaris-Summer-Editions-2023"] .Polaris-ActionList__Item { position: relative; /* stylelint-disable-next-line polaris/conventions/polaris/custom-property-allowed-list -- se23 */ --pc-action-list-item-min-height: var(--p-space-800); padding: var(--p-space-150); border-radius: var(--p-border-radius-2); align-items: center; display: flex; }
...
.Polaris-ActionList__Item.Polaris-ActionList--indented::before { content: ''; position: absolute; top: calc(var(--p-space-300)*-1); bottom: 0; left: 0; border-left: var(--p-border-width-1) solid var(--p-color-border); margin-left: calc(var(--p-space-150)*-1); }
...
.Polaris-Tooltip-TooltipOverlay::after { content: ''; position: absolute; top: calc(var(--p-space-400)*-1); left: calc(var(--pc-tooltip-chevron-x-pos) - var(--p-space-200) - var(--p-space-400)); height: 0; width: 0; border-width: var(--p-space-200); border-style: solid; border-color: transparent transparent var(--p-color-bg) transparent; }
...
.Polaris-Tooltip-TooltipOverlay.Polaris-Tooltip-TooltipOverlay--positionedAbove::after { top: auto; bottom: calc(var(--p-space-400)*-1); border-color: var(--p-color-bg) transparent transparent transparent; }
...
.Polaris-Button { --pc-button-micro-min-height: var(--p-font-line-height-2); --pc-button-slim-min-height: var(--p-font-line-height-4); --pc-button-large-min-height: 2.75rem; --pc-button-vertical-padding: calc((2.25rem - var(--p-font-line-height-2) - var(--p-space-050))/2); --pc-button-slim-vertical-padding: calc((var(--pc-button-slim-min-height) - var(--p-font-line-height-2) - var(--p-space-050))/2); --pc-button-large-vertical-padding: calc((var(--pc-button-large-min-height) - var(--p-font-line-height-2) - var(--p-space-050))/2); --pc-button-spinner-size: 1.25rem; --pc-button-segment: 10; --pc-button-focused: 20; --pc-button-disclosure-icon-offset: -0.375rem; position: relative; position: relative; display: inline-flex; align-items: center; justify-content: center; min-height: 2.25rem; min-width: 2.25rem; margin: 0; padding: calc((2.25rem - var(--p-font-line-height-2) - var(--p-space-050))/2) var(--p-space-400); background: var(--p-color-bg); box-shadow: var(--p-shadow-sm); border-radius: var(--p-border-radius-1); color: var(--p-color-text); border: var(--p-border-width-1) solid var(--p-color-border-strong); line-height: 1; text-align: center; cursor: pointer; -webkit-user-select: none; user-select: none; text-decoration: none; -webkit-tap-highlight-color: transparent; }
...
html[class~="Polaris-Summer-Editions-2023"] .Polaris-Button { min-height: 1.75rem; min-width: 1.75rem; padding: var(--p-space-150) var(--p-space-300); border-radius: var(--p-border-radius-2); border: none; }
...
html[class~="Polaris-Summer-Editions-2023"] .Polaris-Button { --pc-button-shadow: inset 0 -0.0625rem 0 #b5b5b5, inset -0.0625rem 0 0 #e3e3e3,
      ...
      inset -0.0625rem 0 0 rgba(255, 255, 255, 0.25); --pc-button-large-min-height: 2rem; --pc-button-large-vertical-padding: var(--p-space-200); --pc-button-micro-min-height: var(--p-font-line-height-3); box-shadow: var(--pc-button-shadow); transition: background-color 75ms var(--p-motion-ease-out), box-shadow 75ms var(--p-motion-ease-out); }
...
.Polaris-Button--plain { margin: calc(var(--pc-button-vertical-padding)*-1) calc(var(--p-space-200)*-1); padding-left: var(--p-space-200); padding-right: var(--p-space-200); background: transparent; border: 0; box-shadow: none; color: var(--p-color-text-interactive); }
...
html[class~="Polaris-Summer-Editions-2023"] .Polaris-Button--plain:focus-visible > .Polaris-Button__Content { outline: var(--p-border-width-2) solid var(--p-color-border-interactive-focus); outline-offset: var(--p-space-050); border-radius: var(--p-border-radius-1_5-experimental); }
...
.Polaris-Button--sizeMicro { border-radius: var(--p-border-radius-1); padding: var(--p-space-100) var(--p-space-200); min-height: var(--pc-button-micro-min-height); }
...
html[class~="Polaris-Summer-Editions-2023"] .Polaris-ActionMenu-SecondaryAction a, html[class~="Polaris-Summer-Editions-2023"] .Polaris-ActionMenu-SecondaryAction button { border: none; min-height: 1.75rem; padding: var(--p-space-100) var(--p-space-300); background-color: var(--p-color-bg-strong) !important; border-radius: var(--p-border-radius-2) !important; /* stylelint-disable-next-line selector-max-combinators -- se23 */ /* stylelint-disable-next-line selector-max-combinators -- se23 */ /* stylelint-disable-next-line selector-max-combinators -- se23 */ }

html[class~="Polaris-Summer-Editions-2023"] .Polaris-ActionMenu-SecondaryAction a:is(:hover, :focus), html[class~="Polaris-Summer-Editions-2023"] .Polaris-ActionMenu-SecondaryAction button:is(:hover, :focus) { background-color: var(--p-color-bg-strong-hover) !important; }

html[class~="Polaris-Summer-Editions-2023"] .Polaris-ActionMenu-SecondaryAction a:active, html[class~="Polaris-Summer-Editions-2023"] .Polaris-ActionMenu-SecondaryAction button:active { background-color: var(--p-color-bg-strong-active) !important; box-shadow: var(--p-shadow-inset-md) !important; }

html[class~="Polaris-Summer-Editions-2023"] .Polaris-ActionMenu-SecondaryAction a:focus-visible, html[class~="Polaris-Summer-Editions-2023"] .Polaris-ActionMenu-SecondaryAction button:focus-visible { /* stylelint-disable-next-line polaris/border/polaris/at-rule-disallowed-list -- se23 */ outline: var(--p-border-width-2) solid var(--p-color-border-interactive-focus); outline-offset: var(--p-space-050); }
...
html[class~="Polaris-Summer-Editions-2023"] .Polaris-ActionMenu-RollupActions__RollupActivator button[type='button']:focus:not(:active) { /* stylelint-disable-next-line polaris/border/polaris/at-rule-disallowed-list -- se23 button overrides */ outline: var(--p-border-width-2) solid var(--p-color-border-interactive-focus); outline-offset: var(--p-space-050); background: var(--p-color-bg-strong-active); }
...
.Polaris-TextField__Input { font-size: var(--p-font-size-200); font-weight: var(--p-font-weight-regular); line-height: var(--p-font-line-height-2); letter-spacing: initial; position: relative; z-index: var(--pc-text-field-contents); display: block; flex: 1 1; width: 100%; min-width: 0; min-height: 2.25rem; margin: 0; padding: calc((2.25rem - var(--p-font-line-height-3) - var(--p-space-050))/2) var(--p-space-300); background: none; border: var(--p-border-width-1) solid transparent; font-family: var(--p-font-family-sans); -webkit-appearance: none; appearance: none; caret-color: var(--p-color-text); color: var(--p-color-text); }

html[class~="Polaris-Summer-Editions-2023"] .Polaris-TextField__Input { min-height: 2rem; display: flex; align-items: center; line-height: var(--p-font-line-height-3); padding-top: var(--p-space-150); padding-bottom: var(--p-space-150); border: 0; }
...
.Polaris-TextField--borderless .Polaris-TextField__Input, .Polaris-TextField--borderless .Polaris-TextField__Backdrop { border: none; line-height: var(--p-font-line-height-1); min-height: var(--p-space-800); }
...
.Polaris-TextField__VerticalContent { position: relative; z-index: var(--pc-text-field-contents); color: var(--p-color-text-subdued); padding: var(--p-space-200) var(--p-space-200) 0 var(--p-space-200); max-height: 8.75rem; overflow: scroll; border: var(--p-border-width-1) solid transparent; width: 100%; }
...
.Polaris-TextField__CharacterCount { color: var(--p-color-text-subdued); z-index: var(--pc-text-field-contents); margin: 0 var(--p-space-300) 0 var(--p-space-100); pointer-events: none; text-align: right; }
...
html[class~="Polaris-Summer-Editions-2023"] .Polaris-Checkbox--error .Polaris-Checkbox__Backdrop:active { box-shadow: inset 0 0 0 var(--p-space-050) var(--p-color-bg-critical-strong-active); }
...
html[class~="Polaris-Summer-Editions-2023"] .Polaris-Checkbox--error .Polaris-Checkbox__Input:active + .Polaris-Checkbox__Backdrop { box-shadow: inset 0 0 0 var(--p-space-050) var(--p-color-bg-critical-strong-active); }
...
.Polaris-Listbox-TextOption { margin: var(--p-space-100) var(--p-space-200) 0; flex: 1 1; border-radius: var(--p-border-radius-1); padding: var(--p-space-200) var(--p-space-200); cursor: pointer; display: flex; position: relative; }
...
html[class~="Polaris-Summer-Editions-2023"] .Polaris-Listbox-TextOption { border-radius: var(--p-border-radius-2); padding: var(--p-space-150) var(--p-space-300); }
...
.Polaris-Autocomplete-MappedAction__ActionContainer { --pc-mapped-actions-image-size: 1.25rem; --pc-mapped-actions-item-min-height: var(--p-space-1000); --pc-mapped-actions-item-vertical-padding: calc((var(--pc-mapped-actions-item-min-height) - var(--p-font-line-height-2))/2); margin-bottom: var(--p-space-300); }
...
.Polaris-Autocomplete-MappedAction__Action { position: relative; display: block; flex: 1 1; min-height: var(--pc-mapped-actions-item-min-height); text-align: left; cursor: pointer; padding: var(--pc-mapped-actions-item-vertical-padding) var(--p-space-200); margin: calc(var(--pc-mapped-actions-item-vertical-padding)*-1) calc(var(--p-space-200)*-1); border-radius: var(--p-border-radius-1); }
...
html[class~="Polaris-Summer-Editions-2023"] .Polaris-Autocomplete-MappedAction__Action { border-radius: var(--p-border-radius-2); margin: calc(var(--pc-mapped-actions-item-vertical-padding)*-1) calc(var(--p-space-300)*-1); }
...
.Polaris-Autocomplete-MappedAction__Prefix { display: flex; flex: 0 0 auto; justify-content: center; align-items: center; height: var(--pc-mapped-actions-image-size); width: var(--pc-mapped-actions-image-size); border-radius: var(--p-border-radius-1); margin: calc(var(--pc-mapped-actions-image-size)*-0.5) var(--p-space-400) calc(var(--pc-mapped-actions-image-size)*-0.5) 0; background-size: cover; background-position: center center; }
...
.Polaris-Banner--withinContentContainer { padding: var(--p-space-400); border: var(--p-border-width-1) solid var(--p-color-border-strong); background-color: var(--p-color-bg-app); border-radius: var(--p-border-radius-1); }
...
.Polaris-Banner--withinPage { border-radius: 0 0 var(--p-border-radius-1) var(--p-border-radius-1); padding: var(--p-space-500); border: var(--p-border-width-1) solid var(--p-color-border-strong); background-color: var(--p-color-bg-app); border-radius: 0; border-width: var(--p-border-width-1) 0; }
...
.Polaris-Banner__SecondaryAction:focus-visible > .Polaris-Banner__Text { padding: var(--p-space-050) var(--p-space-100); margin: calc(var(--p-space-050)*-1) calc(var(--p-space-100)*-1); background: transparent; border-radius: var(--p-border-radius-1); box-shadow: none; text-decoration: underline; }
...
html[class~="Polaris-Summer-Editions-2023"] .Polaris-Banner__Button { min-height: 1.75rem; min-width: 1.75rem; padding: var(--p-space-150) var(--p-space-300); border-radius: var(--p-border-radius-2); border: none; }
...
html[class~="Polaris-Summer-Editions-2023"] .Polaris-Breadcrumbs__Breadcrumb:focus { /* stylelint-disable-next-line polaris/border/polaris/at-rule-disallowed-list -- se23 */ outline: var(--p-border-width-2) solid var(--p-color-border-interactive-focus); outline-offset: var(--p-space-050); }
...
.Polaris-BulkActions__ButtonGroupWrapper { width: auto; justify-content: flex-start; padding: var(--p-space-400); background: var(--p-color-bg); border-radius: var(--p-border-radius-2); box-shadow: var(--p-shadow-md), var(--p-shadow-xl); max-width: 100%; pointer-events: auto; }

html[class~="Polaris-Summer-Editions-2023"] .Polaris-BulkActions__ButtonGroupWrapper { padding: var(--p-space-300); position: relative; box-shadow: var(--p-shadow-md); border-radius: var(--p-border-radius-3); border: var(--pc-app-provider-shadow-bevel-border); }
...
html[class~="Polaris-Summer-Editions-2023"] .Polaris-BulkActions__BulkActionButton button:focus-visible:not(:active) { /* stylelint-disable-next-line polaris/border/polaris/at-rule-disallowed-list -- se23 */ outline: var(--p-border-width-2) solid var(--p-color-border-interactive-focus); outline-offset: var(--p-space-050); }
...
.Polaris-LegacyCard__Header + .Polaris-LegacyCard__Section--subdued { border-top: var(--p-border-width-1) solid var(--p-color-border-subdued); margin-top: var(--p-space-500); }
...
.Polaris-LegacyCard__Subsection + .Polaris-LegacyCard__Subsection { margin-top: var(--p-space-400); padding-top: var(--p-space-400); border-top: var(--p-border-width-1) solid var(--p-color-border-subdued); }
...
.Polaris-LegacyCard__Section--subdued + .Polaris-LegacyCard__Footer { border-top: var(--p-border-width-1) solid var(--p-color-border-subdued); padding: var(--p-space-500); }
...
.Polaris-ColorPicker__MainColor { background: repeating-conic-gradient(var(--p-color-bg) 0% 25%, var(--p-color-bg-subdued) 0% 50%) 50%/var(--p-space-400) var(--p-space-400); position: relative; overflow: hidden; height: var(--pc-color-picker-size); width: var(--pc-color-picker-size); border-radius: var(--p-border-radius-1); cursor: pointer; }
...
.Polaris-ColorPicker__HuePicker, .Polaris-ColorPicker__AlphaPicker { position: relative; overflow: hidden; height: var(--pc-color-picker-size); width: var(--p-space-600); margin-left: var(--p-space-200); border-width: var(--p-border-radius-1); border-radius: calc(var(--pc-color-picker-size)*0.5); }
...
.Polaris-ColorPicker__AlphaPicker { background: repeating-conic-gradient(var(--p-color-bg) 0% 25%, var(--p-color-bg-subdued) 0% 50%) 50%/var(--p-space-400) var(--p-space-400); }
...
html[class~="Polaris-Summer-Editions-2023"] .Polaris-DataTable__Cell--header { padding-top: var(--p-space-300); padding-bottom: var(--p-space-300); border-bottom: var(--p-border-width-1) solid var(--p-color-border); }
...
html[class~="Polaris-Summer-Editions-2023"] .Polaris-DataTable__Cell--total { border-bottom: var(--p-border-width-1) solid var(--p-color-border); }
...
.Polaris-DataTable__Footer { padding: var(--p-space-400); background: var(--p-color-bg-subdued); color: var(--p-color-text-subdued); text-align: center; border-top: var(--p-border-width-1) solid var(--p-color-border-subdued); border-bottom-left-radius: var(--p-border-radius-2); border-bottom-right-radius: var(--p-border-radius-2); }

html[class~="Polaris-Summer-Editions-2023"] .Polaris-DataTable__Footer { padding: var(--p-space-200) var(--p-space-300); border-top: var(--p-border-width-1) solid var(--p-color-border); border-radius: 0; }
...
.Polaris-DatePicker__Day { display: block; height: 100%; width: 100%; margin: 0; padding: var(--p-space-200); background: transparent; border: none; border-radius: var(--p-border-radius-1); outline: none; font-size: var(--p-font-size-75); text-align: center; color: var(--p-color-text); cursor: pointer; position: relative; }
...
.Polaris-DatePicker__Weekday { padding: var(--p-space-200); background: transparent; font-size: var(--p-font-size-75); font-weight: var(--p-font-weight-regular); color: var(--p-color-text-subdued); text-align: center; }
...
html[class~="Polaris-Summer-Editions-2023"] .Polaris-DropZone-FileUpload__Action { color: var(--p-color-text); background-color: var(--p-color-bg-input); padding: var(--p-space-150) var(--p-space-300); box-shadow: var(--p-shadow-button-experimental); border-radius: var(--p-border-radius-2); }
...
.Polaris-DropZone__Overlay { border-radius: var(--p-border-radius-2); position: absolute; z-index: var(--pc-drop-zone-overlay); top: 0; right: 0; bottom: 0; left: 0; display: flex; justify-content: center; align-items: center; padding: var(--p-space-400); border: var(--p-border-width-1) dashed var(--p-color-border-interactive); text-align: center; color: var(--p-color-text-interactive); background-color: var(--p-color-bg-interactive-selected); pointer-events: none; }
...
.Polaris-ExceptionList__Item { position: relative; padding-left: var(--p-space-600); color: var(--p-color-text-subdued); }
...
.Polaris-Filters__AddFilter { background: var(--p-color-bg-subdued); border-radius: var(--p-border-radius-6); border: var(--p-color-border-subdued) dashed var(--p-border-width-1); padding: 0 var(--p-space-200) 0 var(--p-space-300); height: 1.75rem; cursor: pointer; color: var(--p-color-text); display: flex; align-items: center; justify-content: center; outline: inherit; position: relative; }

.Polaris-Filters__AddFilter::after { content: ''; position: absolute; z-index: 1; top: calc(var(--p-border-width-1)*-1 + -0.0625rem); right: calc(var(--p-border-width-1)*-1 + -0.0625rem); bottom: calc(var(--p-border-width-1)*-1 + -0.0625rem); left: calc(var(--p-border-width-1)*-1 + -0.0625rem); display: block; pointer-events: none; box-shadow: 0 0 0 calc(var(--p-border-width-1)*-1 + -0.0625rem) var(--p-color-border-interactive-focus); border-radius: var(--p-border-radius-1); }

.Polaris-Filters__AddFilter path { fill: var(--p-color-icon); }

@media (min-width: 48em) { .Polaris-Filters__AddFilter { font-size: var(--p-font-size-75); line-height: var(--p-font-line-height-1); height: 1.5rem; padding: 0 0.375rem 0 var(--p-space-200); } }
...
@media (max-width: 47.9975em) { .Polaris-Filters__FiltersWrapperWithAddButton { position: relative; }
  ...
  .Polaris-Filters__AddFilterActivatorMultiple { position: sticky; z-index: var(--p-z-index-1); top: 0; right: 0; display: flex; padding: var(--p-space-100) var(--p-space-400) var(--p-space-100) 0; background: var(--p-color-bg); margin-left: var(--p-space-200); }
...
.Polaris-Frame-Toast { display: inline-flex; max-width: 31.25rem; padding: var(--p-space-200) var(--p-space-300); border-radius: var(--p-border-radius-1); background: var(--p-color-bg-inverse); color: var(--p-color-text-on-color); margin-bottom: var(--p-space-500); box-shadow: var(--p-shadow-xl); }
...
.Polaris-Frame-Toast__CloseButton { display: flex; align-self: center; flex-direction: column; justify-content: flex-start; padding: 0; border: none; -webkit-appearance: none; appearance: none; background: transparent; color: var(--p-color-icon-subdued); cursor: pointer; margin-left: var(--p-space-200); }
...
.Polaris-Modal-CloseButton { -webkit-appearance: none; appearance: none; margin: 0; padding: 0; background: none; border: none; font-size: inherit; line-height: inherit; color: inherit; cursor: pointer; position: relative; margin-left: var(--p-space-500); margin-right: calc(var(--p-space-200)*-1); padding: var(--p-space-200); border-radius: var(--p-border-radius-2); }
...
html[class~="Polaris-Summer-Editions-2023"] .Polaris-Frame__Skip > a { min-height: 1.75rem; min-width: 1.75rem; padding: var(--p-space-150) var(--p-space-300); border-radius: var(--p-border-radius-2); border: none; }
...
.Polaris-FullscreenBar__BackAction { display: flex; flex: 0 1 auto; align-items: center; padding-left: var(--p-space-300); padding-right: var(--p-space-300); border-width: 0; border-right: var(--p-border-width-1) solid var(--p-color-border-subdued); background-color: var(--p-color-bg); font-weight: var(--p-font-weight-medium); cursor: pointer; }
...
.Polaris-Tabs__Tab { position: relative; -webkit-tap-highlight-color: rgba(0, 0, 0, 0); position: relative; display: inline-flex; justify-content: center; align-items: center; height: var(--p-space-800); padding: 0 var(--p-space-300); border: 0; border-radius: var(--p-border-radius-1); background: var(--p-color-bg); color: var(--p-color-text-subdued); cursor: pointer; text-decoration: none; width: 100%; min-width: 100%; margin-top: var(--p-space-025); margin-bottom: calc(var(--p-space-025)*-1); outline: none; text-align: center; white-space: nowrap; }
...
html[class~="Polaris-Summer-Editions-2023"] .Polaris-Tabs__Tab { position: relative; color: var(--p-color-text-primary); background-color: transparent; border-radius: var(--p-border-radius-2); padding: var(--p-space-150) var(--p-space-300); height: 2rem; }
...
.Polaris-Tabs__Item { -webkit-appearance: none; appearance: none; margin: 0; padding: 0; background: none; border: none; font-size: inherit; line-height: inherit; color: inherit; cursor: pointer; position: relative; display: block; width: 100%; min-height: var(--item-min-height); padding: var(--item-vertical-padding) var(--p-space-400); text-align: left; text-decoration: none; cursor: pointer; border-radius: var(--p-border-radius-1); color: inherit; }
...
.Polaris-Tabs__DisclosureActivator { position: relative; -webkit-appearance: none; appearance: none; margin: 0; padding: 0; background: none; border: none; font-size: inherit; line-height: inherit; color: inherit; cursor: pointer; height: 100%; background-color: transparent; color: var(--p-color-text-subdued); display: flex; align-items: center; justify-content: center; cursor: pointer; border-radius: var(--p-border-radius-1); padding: 0 var(--p-space-200) 0 var(--p-space-300); margin-top: var(--p-space-025); border: none; outline: none; }
...
html[class~="Polaris-Summer-Editions-2023"] .Polaris-IndexFilters-FilterButton { min-height: 1.75rem; min-width: 1.75rem; padding: var(--p-space-150) var(--p-space-300); border-radius: var(--p-border-radius-2); border: none; }
...
.Polaris-SortButton-DirectionButton { position: relative; border-radius: var(--p-border-radius-1); padding: var(--p-space-050); font-size: var(--p-font-size-100); display: flex; align-items: center; justify-content: flex-start; cursor: pointer; width: 100%; border: none; background: none; text-align: left; }
...
html[class~="Polaris-Summer-Editions-2023"] .Polaris-SortButton-DirectionButton { position: relative; border-radius: var(--p-border-radius-2); padding: var(--p-space-100) var(--p-space-300) var(--p-space-100) var(--p-space-200); }
...
html[class~="Polaris-Summer-Editions-2023"] .Polaris-SortButton-DirectionButton__Label { color: var(--p-color-text); margin-left: var(--p-space-050); font-size: var(--p-font-size-75); font-weight: var(--p-font-weight-medium); line-height: var(--p-font-line-height-1); }
...
.Polaris-IndexFilters__TabsWrapperLoading .Polaris-IndexFilters__TabsLoading::before { content: ''; position: absolute; top: 0; left: -1rem; width: var(--p-space-400); height: 100%; pointer-events: none; background: linear-gradient(to right, rgba(255, 255, 255, 0), var(--p-color-bg)); }
...
@media (max-width: 47.9975em) { .Polaris-IndexFilters__ActionWrap { position: relative; padding: var(--p-space-300) var(--p-space-400); border-left: var(--p-border-width-1) solid var(--p-color-border-subdued); gap: var(--p-space-200); }
  .Polaris-IndexFilters__ActionWrap::before { content: ''; position: absolute; top: 0; left: -1.0625rem; width: var(--p-space-400); height: 100%; pointer-events: none; background: linear-gradient(to right, rgba(255, 255, 255, 0), var(--p-color-bg)); } }
...
.Polaris-IndexTable__LoadingPanel { position: absolute; z-index: var(--p-z-index-2); top: 0; left: 0; display: flex; width: 100%; justify-content: center; align-items: center; background: var(--p-color-bg); padding: var(--p-space-200) var(--p-space-400); box-shadow: var(--p-shadow-md); }

.Polaris-IndexTable__LoadingPanel .Polaris-IndexTable__LoadingPanelRow { display: flex; flex-wrap: nowrap; width: 100%; background: var(--p-color-bg-info-subdued); padding: var(--p-space-200); padding-bottom: var(--p-space-100); border-radius: var(--p-border-radius-1); }
...
.Polaris-IndexTable__TableRow { background-color: var(--p-color-bg); cursor: pointer; border-top: var(--p-border-width-1) solid var(--p-color-border-subdued); /* stylelint-disable-next-line selector-max-class -- generated by polaris-migrator DO NOT COPY */ }
...
.Polaris-IndexTable__TableHeading { --pc-index-table-heading-padding-x: var(--p-space-400); --pc-index-table-heading-padding-y: var(--p-space-200); background: var(--p-color-bg-subdued); padding: var(--pc-index-table-heading-padding-y) var(--pc-index-table-heading-padding-x); text-align: left; font-weight: var(--p-font-weight-medium); color: var(--p-color-text-subdued); font-size: var(--p-font-size-75); white-space: nowrap; border: 0; }
...
.Polaris-IndexTable__StickyTableHeader--isSticky { visibility: visible; background-color: var(--p-color-bg-subdued); box-shadow: var(--p-shadow-md); }
...
.Polaris-IndexTable__SelectAllActionsWrapper { visibility: visible; position: relative; z-index: var(--pc-index-table-bulk-actions); top: 0; left: 0; right: 0; padding: 0 var(--p-space-200) 0 var(--p-space-400); background: var(--p-color-bg); }
...
html[class~="Polaris-Summer-Editions-2023"] .Polaris-IndexTable__SelectAllActionsWrapper { position: static; padding-left: var(--p-space-300); padding-top: var(--p-space-150); padding-bottom: var(--p-space-150); line-height: var(--p-font-line-height-2); }

.Polaris-IndexTable__ScrollBarContainer { --pc-index-table-scroll-bar: 35; position: sticky; z-index: var(--pc-index-table-scroll-bar); bottom: 0; padding: var(--p-space-050); background-color: var(--p-color-bg); border-bottom-right-radius: var(--p-border-radius-2); border-bottom-left-radius: var(--p-border-radius-2); }
...
@media (min-width: 30.625em) { html[class~="Polaris-Summer-Editions-2023"] .Polaris-IndexTable__ScrollBarContainer { border-bottom-right-radius: var(--p-border-radius-2); border-bottom-left-radius: var(--p-border-radius-2); padding: var(--p-space-050) var(--p-space-200); } }
...
.Polaris-IndexTable__HeaderWrapper { position: relative; display: flex; align-items: center; width: 100%; min-height: 3.5rem; padding: var(--p-space-200) var(--p-space-400); background-color: var(--p-color-bg); }
...
.Polaris-CheckableButton__Label { flex: 1 1; white-space: nowrap; overflow: hidden; max-width: 100%; text-overflow: ellipsis; padding: var(--p-space-025) 0; margin-left: calc(var(--p-space-500) - var(--p-border-width-2)); }
...
.Polaris-InlineCode__Code { background-color: var(--p-color-bg-strong); border-radius: var(--p-border-radius-05); font-family: var(--p-font-family-mono); font-size: 0.85em; font-weight: var(--p-font-weight-medium); padding: var(--p-space-025) var(--p-space-100); }


.Polaris-KeyboardKey { height: 1.75rem; display: inline-flex; justify-content: center; margin: 0 var(--p-space-050) var(--p-space-050); padding: 0 var(--p-space-200); background: var(--p-color-bg-inset); box-shadow: 0 var(--p-space-025) 0 rgba(0, 0, 0, 0.15); border-radius: var(--p-border-radius-1); color: var(--p-color-text); font-size: var(--p-font-size-100); font-weight: var(--p-font-weight-medium); font-family: var(--p-font-family-sans); line-height: 1.75rem; text-align: center; min-width: 1.75rem; -webkit-user-select: none; user-select: none; }
...
.Polaris-KeyboardKey--small { background: var(--p-color-bg-app-selected); border-radius: var(--p-border-radius-05); box-shadow: none; line-height: unset; padding: 0 var(--p-space-100); font-size: var(--p-font-size-75); height: var(--p-space-500); min-width: var(--p-space-500); }
...
html[class~="Polaris-Summer-Editions-2023"] .Polaris-Layout__Section + .Polaris-Layout__AnnotatedSection, html[class~="Polaris-Summer-Editions-2023"] .Polaris-Layout__AnnotatedSection + .Polaris-Layout__AnnotatedSection { border-top: var(--p-border-width-1) solid var(--p-color-border-subdued); padding-top: var(--p-space-400); }

@media (min-width: 30.625em) { .Polaris-Layout__Section + .Polaris-Layout__AnnotatedSection, .Polaris-Layout__AnnotatedSection + .Polaris-Layout__AnnotatedSection { padding-top: var(--p-space-400); border-top: var(--p-border-width-1) solid var(--p-color-border-subdued); } }
...
.Polaris-Tag { display: inline-flex; max-width: 100%; align-items: center; min-height: 1.75rem; padding: 0 var(--p-space-200); background-color: var(--p-color-bg-strong); border-radius: var(--p-border-radius-1); color: var(--p-color-text); }
...
.Polaris-Tag.Polaris-Tag--clickable { -webkit-appearance: none; appearance: none; margin: 0; padding: 0; background: none; border: none; font-size: inherit; line-height: inherit; color: inherit; cursor: pointer; cursor: pointer; padding: var(--p-space-100) var(--p-space-200); background-color: var(--p-color-bg-strong); outline: var(--p-border-width-1) solid transparent; font-size: 0.8125rem; line-height: var(--p-font-line-height-2); position: relative; }
...
html[class~="Polaris-Summer-Editions-2023"] .Polaris-Tag.Polaris-Tag--clickable { /* stylelint-disable-next-line polaris/border/polaris/at-rule-disallowed-list -- se23 */ position: relative; line-height: var(--p-font-line-height-1); padding: 0 calc(var(--p-space-100) + var(--p-space-050)); }
...
html[class~="Polaris-Summer-Editions-2023"] .Polaris-Tag { min-height: 1.25rem; border-radius: var(--p-border-radius-2); padding-inline: calc(var(--p-space-100) + var(--p-space-050)); }
...
.Polaris-Tag__TagText { font-size: 0.8125rem; line-height: var(--p-font-line-height-2); min-height: 1.25rem; padding: var(--p-space-100) 0; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; vertical-align: middle; }
...
html[class~="Polaris-Summer-Editions-2023"] .Polaris-Tag__Button { /* stylelint-disable-next-line polaris/border/polaris/at-rule-disallowed-list -- se23 */ position: relative; /* stylelint-disable-next-line polaris/border/declaration-property-unit-disallowed-list -- se23 */ border-radius: 0.4375rem; margin: var(--p-space-025); margin-left: var(--p-space-050); width: 1.125rem; height: 1.125rem; color: var(--p-color-icon-subdued); /* stylelint-disable-next-line selector-max-combinators -- se23 */ }
...
.Polaris-Tag__Link { display: inline-grid; color: var(--p-color-text); outline: none; border-radius: var(--p-border-radius-1); text-decoration: none; min-height: 1.25rem; padding: 0 var(--p-space-200); position: relative; }

.Polaris-Tag__Link .Polaris-Tag__LinkText { overflow: hidden; white-space: nowrap; text-overflow: ellipsis; font-size: 0.8125rem; line-height: var(--p-font-line-height-2); padding-top: var(--p-space-100); padding-bottom: var(--p-space-100); }
...
.Polaris-LegacyFilters__LegacyFiltersContainerHeader { top: 0; width: 100%; padding: var(--p-space-400) var(--p-space-500); border-bottom: var(--p-border-width-1) solid var(--p-color-border-subdued); height: 3.5rem; box-sizing: border-box; display: flex; align-items: center; justify-content: space-between; }
...
.Polaris-LegacyFilters__LegacyFiltersContainerFooter { position: absolute; bottom: 0; width: 100%; padding: var(--p-space-400) var(--p-space-500); border-top: var(--p-border-width-1) solid var(--p-color-border-subdued); height: 4.375rem; box-sizing: border-box; display: flex; align-items: center; justify-content: space-between; }
...
.Polaris-LegacyFilters__EmptyFooterState { border-top: var(--p-border-width-1) solid var(--p-color-border-subdued); padding-top: var(--p-space-400); width: 100%; display: flex; justify-content: center; }

.Polaris-LegacyFilters__FilterTriggerContainer { position: relative; }

.Polaris-LegacyFilters__FilterTrigger { width: 100%; margin: 0; padding: var(--p-space-400) var(--p-space-500); color: var(--p-color-text); border-radius: var(--p-border-radius-1); background: none; border: none; outline: none; position: relative; }
...
.Polaris-LegacyFilters--open::before, .Polaris-LegacyFilters--open::after { content: ''; position: relative; left: var(--p-space-400); width: calc(100% - var(--p-space-800)); height: var(--p-space-025); background-color: var(--p-color-bg-subdued); display: block; }
...
.Polaris-LegacyFilters--open.Polaris-LegacyFilters--first::after { content: ''; bottom: 0; position: relative; left: var(--p-space-400); width: calc(100% - var(--p-space-800)); height: var(--p-space-025); background-color: var(--p-color-bg-subdued); display: block; }
...
.Polaris-LegacyFilters--open.Polaris-LegacyFilters--last::before { content: ''; top: 0; position: relative; left: var(--p-space-400); width: calc(100% - var(--p-space-800)); height: var(--p-space-025); background-color: var(--p-color-bg-subdued); display: block; }
...
.Polaris-LegacyTabs__Title { position: relative; border-radius: var(--p-border-radius-1); display: block; padding: var(--p-space-200) var(--p-space-400); min-width: 3.125rem; color: var(--p-color-text-subdued); }
...
.Polaris-LegacyTabs__Title::before { content: ''; position: absolute; bottom: calc(var(--p-space-200)*-1); left: 0; right: 0; height: var(--p-border-width-3); border-top-left-radius: var(--p-border-radius-1); border-top-right-radius: var(--p-border-radius-1); }

html[class~="Polaris-Summer-Editions-2023"] .Polaris-LegacyTabs__Title { color: var(--p-color-text-primary); font-weight: var(--p-font-weight-semibold); padding: var(--p-space-150) var(--p-space-300); }
...
.Polaris-LegacyTabs__Item { -webkit-appearance: none; appearance: none; margin: 0; padding: 0; background: none; border: none; font-size: inherit; line-height: inherit; color: inherit; cursor: pointer; position: relative; display: block; width: 100%; min-height: 1rem; padding: 0.5rem var(--p-space-400); text-align: left; text-decoration: none; cursor: pointer; border-radius: var(--p-border-radius-1); color: inherit; }
...
html[class~="Polaris-Summer-Editions-2023"] .Polaris-Link:focus, html[class~="Polaris-Summer-Editions-2023"] .Polaris-Link:focus-visible { outline: var(--p-color-border-interactive-focus) auto var(--p-border-width-2); outline-offset: var(--p-space-050); border-radius: var(--p-border-radius-1_5-experimental); }
...
@media (max-width: 47.9975em) { .Polaris-Navigation__LogoContainer { display: flex; flex: 0 0 3.5rem; align-items: center; height: 3.5rem; padding: 0 var(--p-space-200) 0 var(--p-space-400); background-color: var(--p-color-bg); box-shadow: var(--p-shadow-sm); margin-bottom: var(--p-space-400); flex-basis: 3.5rem; flex-basis: calc(3.5rem + constant(safe-area-inset-left)); flex-basis: calc(3.5rem + env(safe-area-inset-left)); padding-left: var(--p-space-400); padding-left: calc(var(--p-space-400) + constant(safe-area-inset-left)); padding-left: calc(var(--p-space-400) + env(safe-area-inset-left)); }
...
@media (min-width: 48em) { .Polaris-Navigation__Item { font-size: var(--p-font-size-200); font-weight: var(--p-font-weight-medium); line-height: var(--p-font-line-height-5); padding-left: var(--p-space-300); } }
...
@media (min-width: 48em) { html[class~="Polaris-Summer-Editions-2023"] .Polaris-Navigation__ItemInnerWrapper.Polaris-Navigation--itemInnerWrapperDisplayActionsOnHover:is(:hover, :focus-visible) .Polaris-Navigation__SecondaryActions { background: var(--secondary-actions-on-hover-background-color); }
  html[class~="Polaris-Summer-Editions-2023"] .Polaris-Navigation__ItemInnerWrapper.Polaris-Navigation--itemInnerWrapperDisplayActionsOnHover:is(:hover, :focus-visible) .Polaris-Navigation__SecondaryActions::before { background: linear-gradient(to right, rgba(0, 0, 0, 0), var(--p-color-bg-subdued-hover) var(--p-space-800)); }
...
@media (min-width: 48em) { html[class~="Polaris-Summer-Editions-2023"] .Polaris-Navigation__ItemInnerWrapper:active.Polaris-Navigation--itemInnerWrapperDisplayActionsOnHover .Polaris-Navigation__SecondaryActions::before { background: linear-gradient(to right, rgba(0, 0, 0, 0), var(--p-color-bg-app-selected) var(--p-space-800)); } }
...
.Polaris-Navigation__ItemInnerWrapper--selected .Polaris-Navigation__SecondaryActions::before { background: linear-gradient(to right, rgba(0, 0, 0, 0), var(--p-color-bg-app-selected) var(--p-space-800)); }

html[class~="Polaris-Summer-Editions-2023"] .Polaris-Navigation__ItemInnerWrapper--selected .Polaris-Navigation__SecondaryActions::before { background: linear-gradient(to right, rgba(0, 0, 0, 0), var(--p-color-bg-app-selected) var(--p-space-800)); }
...
.Polaris-Navigation__Item--selected::before { content: ''; position: absolute; top: 0.0625rem; bottom: 0.0625rem; left: calc(var(--p-space-200)*-1); width: 0.1875rem; background-color: var(--p-color-bg-primary); border-top-right-radius: var(--p-border-radius-1); border-bottom-right-radius: var(--p-border-radius-1); }
...
.Polaris-Navigation__Badge { margin-left: var(--p-space-200); display: inline-flex; height: var(--p-font-line-height-2); margin-top: calc(var(--p-space-200) + var(--p-space-050)); margin-right: var(--p-space-400); }
...
.Polaris-Navigation__Text { flex: 1 1 auto; font-size: var(--p-font-size-200); font-weight: var(--p-font-weight-medium); line-height: var(--p-font-line-height-2); margin-top: calc(var(--p-space-200) + var(--p-space-050)); margin-bottom: calc(var(--p-space-200) + var(--p-space-050)); }

html[class~="Polaris-Summer-Editions-2023"] .Polaris-Navigation__Text { font-size: var(--p-font-size-100); margin-top: var(--p-space-200); margin-bottom: var(--p-space-200); }

@media (min-width: 48em) { .Polaris-Navigation__Text { font-size: var(--p-font-size-100); line-height: var(--p-font-line-height-2); margin-top: var(--p-space-100); margin-bottom: var(--p-space-100); }
  html[class~="Polaris-Summer-Editions-2023"] .Polaris-Navigation__Text { margin-top: var(--p-space-100); margin-bottom: var(--p-space-100); font-size: var(--p-font-size-80-experimental); } }
...
@media (min-width: 48em) { .Polaris-Navigation--itemInnerWrapperDisplayActionsOnHover .Polaris-Navigation__SecondaryActions { position: absolute; top: 0; right: 0; background: var(--p-color-bg-app-hover); visibility: hidden; opacity: 0; transition: opacity var(--p-motion-duration-200) ease-in-out, visibility var(--p-motion-duration-200) ease-in-out; }
  html[class~="Polaris-Summer-Editions-2023"] .Polaris-Navigation--itemInnerWrapperDisplayActionsOnHover .Polaris-Navigation__SecondaryActions { z-index: var(--p-z-index-2); background: var(--p-color-bg-subdued-hover); padding: 0 var(--p-space-050); margin-right: 0; border-top-right-radius: var(--p-border-radius-2); border-bottom-right-radius: var(--p-border-radius-2); transition: none; }
  ...
  html[class~="Polaris-Summer-Editions-2023"] .Polaris-Navigation--itemInnerWrapperDisplayActionsOnHover .Polaris-Navigation__SecondaryActions::before { background: linear-gradient(to right, rgba(0, 0, 0, 0), var(--p-color-bg-subdued-hover) var(--p-space-800)); }
...
.Polaris-Navigation__SecondaryAction { -webkit-appearance: none; appearance: none; margin: 0; padding: 0; background: none; border: none; font-size: inherit; line-height: inherit; color: inherit; cursor: pointer; display: flex; align-items: center; height: 2.5rem; padding: var(--p-space-100) calc(var(--p-space-200) + var(--p-space-050)); border-radius: var(--p-border-radius-1); position: relative; }

.Polaris-Navigation__SecondaryAction:focus { outline: none; }

html[class~="Polaris-Summer-Editions-2023"] .Polaris-Navigation__SecondaryAction { padding: calc(var(--p-space-200) - var(--p-space-050)) var(--p-space-200); height: calc(100% - var(--p-space-100)); border-radius: var(--p-border-radius-2); }
...
.Polaris-Navigation__SecondaryNavigation .Polaris-Navigation__Item { font-size: 0.9375rem; line-height: 2.5rem; color: var(--p-color-text-subdued); padding-left: calc(var(--p-space-800) + var(--p-space-300)); }
...
@media (min-width: 48em) { .Polaris-Navigation__SecondaryNavigation .Polaris-Navigation__Item { font-size: var(--p-font-size-100); line-height: 1; padding-left: var(--p-space-1000); } }
...
.Polaris-Navigation__SectionHeading .Polaris-Navigation__Action { -webkit-appearance: none; appearance: none; margin: 0; padding: 0; background: none; border: none; font-size: inherit; line-height: inherit; color: inherit; cursor: pointer; display: flex; align-items: center; margin-right: var(--p-space-100); padding: var(--p-space-100) var(--p-space-400); border-radius: var(--p-border-radius-1); position: relative; }

.Polaris-Navigation__SectionHeading .Polaris-Navigation__Action:focus { outline: none; }

html[class~="Polaris-Summer-Editions-2023"] .Polaris-Navigation__SectionHeading .Polaris-Navigation__Action { padding: calc(var(--p-space-100) - var(--p-space-050)); height: calc(100% - var(--p-space-100)); border-radius: var(--p-border-radius-2); margin-right: calc(var(--p-space-200) + var(--p-space-050)); }
...
.Polaris-OptionList-Option { -webkit-appearance: none; appearance: none; margin: 0; padding: 0; background: none; border: none; font-size: inherit; line-height: inherit; color: inherit; cursor: pointer; width: 100%; min-height: 2.25rem; text-align: left; text-decoration: none; border-radius: var(--p-border-radius-1); margin-top: var(--p-space-100); color: inherit; }
...
.Polaris-OptionList-Option__Label, .Polaris-OptionList-Option__SingleSelectOption, .Polaris-OptionList-Option__MultiSelectOption { display: flex; align-items: flex-start; width: 100%; cursor: pointer; border-radius: var(--p-border-radius-1); padding: var(--p-space-200); word-wrap: break-word; word-break: break-word; overflow-wrap: break-word; }
...
html[class~="Polaris-Summer-Editions-2023"] .Polaris-OptionList-Option__Label, html[class~="Polaris-Summer-Editions-2023"] .Polaris-OptionList-Option__SingleSelectOption, html[class~="Polaris-Summer-Editions-2023"] .Polaris-OptionList-Option__MultiSelectOption { border-radius: var(--p-border-radius-2); padding: var(--p-space-150); }
...
html[class~="Polaris-Summer-Editions-2023"] .Polaris-Pagination.Polaris-Pagination--table button:active, html[class~="Polaris-Summer-Editions-2023"] .Polaris-Pagination.Polaris-Pagination--table button:focus { background-color: var(--p-color-bg-strong-active); }
...
.Polaris-Header-Title__SubTitle { margin-top: var(--p-space-100); color: var(--p-color-text-subdued); }
...
html[class~="Polaris-Summer-Editions-2023"] .Polaris-Page-Header__BreadcrumbWrapper a:is(:hover, :focus-visible), html[class~="Polaris-Summer-Editions-2023"] .Polaris-Page-Header__BreadcrumbWrapper button:is(:hover, :focus-visible) { background-color: var(--p-color-bg-strong-hover); }

html[class~="Polaris-Summer-Editions-2023"] .Polaris-Page-Header__BreadcrumbWrapper a:active, html[class~="Polaris-Summer-Editions-2023"] .Polaris-Page-Header__BreadcrumbWrapper button:active { background-color: var(--p-color-bg-strong-active); /* stylelint-disable-next-line declaration-no-important -- SE23 match button group */ box-shadow: var(--p-shadow-inset-md) !important; }
...
.Polaris-Page--divider { border-top: var(--p-border-width-1) solid var(--p-color-border-subdued); padding-top: var(--p-space-800); }

html[class~="Polaris-Summer-Editions-2023"] .Polaris-Page--divider { border-top: 0; padding-top: 0; }


.Polaris-PageActions { margin: 0 auto; padding: var(--p-space-500); border-top: var(--p-border-width-1) solid var(--p-color-border-subdued); }
...
.Polaris-ProgressBar { --pc-progress-bar-duration: initial; --pc-progress-bar-percent: initial; overflow: hidden; width: 100%; background-color: var(--pc-progress-bar-background); border-radius: var(--p-border-radius-1); }
...
.Polaris-RangeSlider-DualThumb__OutputBubble { position: relative; display: flex; padding: 0 var(--p-space-200); min-width: 2rem; height: 2rem; background-color: var(--p-color-bg); box-shadow: var(--p-shadow-xl); border-radius: var(--p-border-radius-1); transition-property: transform; transition-duration: var(--p-motion-duration-150); transition-timing-function: var(--p-motion-ease); }
...
.Polaris-RangeSlider-SingleThumb__OutputBubble { position: relative; display: flex; box-shadow: var(--p-shadow-xl); padding: 0 var(--p-space-200); min-width: 2rem; height: 2rem; background-color: var(--p-color-bg); border-radius: var(--p-border-radius-1); transition-property: transform; transition-duration: var(--p-motion-duration-200); transition-timing-function: var(--p-motion-ease); outline: var(--p-border-width-1) solid transparent; }
...
html[class~="Polaris-Summer-Editions-2023"] .Polaris-Select__Content { min-height: 2rem; font-size: var(--p-font-size-200); line-height: var(--p-font-line-height-3); padding: var(--p-space-150) var(--p-space-200) var(--p-space-150) var(--p-space-300); }
...
.Polaris-ResourceList__HeaderWrapper { position: relative; display: flex; align-items: flex-start; width: 100%; min-height: 3.5rem; padding: calc(var(--p-space-300) - var(--p-space-050)) var(--p-space-500); background-color: var(--p-color-bg); border-radius: var(--p-border-radius-2); }
...
.Polaris-SkeletonBodyText { height: var(--p-space-200); display: flex; background-color: var(--p-color-bg-strong); border-radius: var(--p-border-radius-1); }
...
.Polaris-SkeletonTabs__Tab::before { content: ''; position: absolute; bottom: -0.0625rem; left: var(--p-space-300); right: var(--p-space-300); height: var(--p-border-width-3); border-top-left-radius: var(--p-border-radius-1); border-top-right-radius: var(--p-border-radius-1); }
...
@media (min-width: 30.625em) { .Polaris-TopBar-Search { position: absolute; top: 100%; max-width: 36.25rem; margin: var(--p-space-100) var(--p-space-500) 0; border-radius: var(--p-border-radius-2); } }
...
html[class~="Polaris-Summer-Editions-2023"] .Polaris-TopBar-SearchField__Input:focus-visible:not(:active) ~ .Polaris-TopBar-SearchField__Backdrop { outline: var(--p-border-width-2) solid var(--p-color-border-interactive-focus); outline-offset: var(--p-space-050); }
...
.Polaris-Menu-Message__Section { max-width: 20.3125rem; margin-top: var(--p-space-200); padding-top: var(--p-space-200); border-top: var(--p-border-width-1) solid var(--p-color-border-subdued); }


.Polaris-TopBar-Menu__ActivatorWrapper { height: 3.5rem; display: flex; align-items: center; }

.Polaris-TopBar-Menu__Activator { -webkit-appearance: none; appearance: none; margin: 0; padding: 0; background: none; border: none; font-size: inherit; line-height: inherit; color: inherit; cursor: pointer; position: relative; color: var(--p-color-text); position: relative; display: flex; justify-content: center; align-items: center; min-width: 2.25rem; padding: var(--p-space-100) var(--p-space-200); border: 0; cursor: pointer; transition: background-color var(--p-motion-duration-100); margin-right: var(--p-space-200); border-radius: var(--p-border-radius-1); }
...
html[class~="Polaris-Summer-Editions-2023"] .Polaris-TopBar-Menu__Activator { color: var(--p-color-text-inverse); padding: var(--p-space-150); background-color: var(--p-color-bg-inset-strong); border-radius: var(--p-border-radius-2); min-width: auto; min-height: 2rem; }
...
html[class~="Polaris-Summer-Editions-2023"] .Polaris-TopBar-Menu__Activator:focus-visible { /* stylelint-disable-next-line polaris/border/polaris/at-rule-disallowed-list -- se23 */ outline: var(--p-border-width-2) solid var(--p-color-border-interactive-focus); outline-offset: var(--p-space-050); }
...
.Polaris-TopBar-Menu__Section { margin-top: var(--p-space-200); padding-top: var(--p-space-200); border-top: var(--p-border-width-1) solid var(--p-color-border-subdued); }
...
.Polaris-TopBar { position: relative; height: 3.5rem; box-shadow: var(--p-shadow-sm); background-color: var(--p-color-bg); gap: var(--p-space-100); }
...
html[class~="Polaris-Summer-Editions-2023"] .Polaris-TopBar__Logo:focus-visible, html[class~="Polaris-Summer-Editions-2023"] .Polaris-TopBar__LogoLink:focus-visible { outline: var(--p-border-width-2) solid var(--p-color-border-interactive-focus); outline-offset: var(--p-space-150); border-radius: var(--p-border-radius-2); }
...
.Polaris-TopBar__NavigationIcon { -webkit-appearance: none; appearance: none; margin: 0; padding: 0; background: none; border: none; font-size: inherit; line-height: inherit; color: inherit; cursor: pointer; position: relative; align-self: center; margin-left: calc(var(--p-space-200) + var(--p-space-050)); margin-right: var(--p-space-200); padding: var(--p-space-200); border-radius: var(--p-border-radius-1); fill: var(--p-color-icon); transition: var(--p-motion-duration-150) fill var(--p-motion-ease) var(--p-motion-duration-50); }
...
.Polaris-VideoThumbnail__Timestamp { position: absolute; bottom: 0; padding: var(--p-space-100) var(--p-space-200) var(--p-space-100) var(--p-space-100); margin-bottom: var(--p-space-400); margin-left: var(--p-space-400); border-radius: var(--p-border-radius-1); color: var(--p-color-text-on-color); background-color: rgba(0, 0, 0, 0.6); text-align: center; transition: background-color var(--p-motion-duration-200) var(--p-motion-ease-in); }
